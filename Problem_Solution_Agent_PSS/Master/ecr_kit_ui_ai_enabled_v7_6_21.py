    ...
    #    setContentsMargins(left, top, right, bottom)
        ...
        browse.clicked.connect(
                lambda: QFileDialog.getOpenFileName(
                        self, "Select Email", "", "Email Files (*.msg *.eml)"
                )
        )
...
# Problem Summary
        ...
        btn_ps = QPushButton("Problem Summary")
        btn_ps.setFixedSize(180, 26)
        ...
        btn_ps.clicked.connect(
                lambda: self.problem_txt.setPlainText("Will be enabled in Future")
        )
