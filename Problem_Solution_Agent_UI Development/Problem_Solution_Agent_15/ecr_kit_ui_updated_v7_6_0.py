...
class OBSPartsTab(QWidget):
    def __init__(self):
        ...
        reset_btn.setStyleSheet('QPushButton { background-color:#26C6DA; color:#00363A; border:1px solid #0F93AA; border-radius:5px; padding:6px 10px; } QPushButton:hover { background-color:#2FD4E5; }')
