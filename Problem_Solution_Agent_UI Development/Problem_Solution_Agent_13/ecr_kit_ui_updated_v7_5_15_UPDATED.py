...
class OrphanAnalysisTab(QWidget):
    def __init__(self):
        ...
        self.subtabs.addTab(PlaceholderTab("OBS all Parts without Replacements"),
                             "OBS all Parts without Replacements")
        self.subtabs.addTab(PlaceholderTab("OBS with or without Replacement"),
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.tabs.addTab(OrphanAnalysisTab(), "Orphan Analysis")
